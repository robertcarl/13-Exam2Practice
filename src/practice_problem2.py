...
def run_test_practice_problem2a():
    ...
    print('--------------------------------------------------')
    # Test 1:
    expected = [21, 10, 90, -14, 17]
    actual = practice_problem2a([12, 1, 81, -23, 8], 9)
    print('===== Test 1 =====')
    print('   Expected:', expected)
    print('   Actual:  ', actual)

    # Test 2:
    expected = [0, 4, 3, -22, 98]
    actual = practice_problem2a([2, 6, 5, -20, 100], -2)
    print('===== Test 2 =====')
    print('   Expected:', expected)
    print('   Actual:  ', actual)

    # Test 3:
    expected = [62, 70, 110, 40, 69]
    actual = practice_problem2a([2, 10, 50, -20, 9], 60)
    print('===== Test 3 =====')
    print('   Expected:', expected)
    print('   Actual:  ', actual)
